...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "GoCI":
		...
		case "Build":
			...
			return (*GoCI).Build(&parent, module, pkg, output)
		case "Generate":
			var parent GoCI
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
		...
		case "Test":
			...
			return (*GoCI).Test(&parent, module, packages, race)
		case "Vet":
			var parent GoCI
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*GoCI).Vet(&parent, module, packages)
		case "":
			var parent GoCI
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {

...
func (r *Engine) UnmarshalJSON(bs []byte) error {
	...
	*r = Engine{query: selectNode(dag.query, id, "Engine")}
	return nil
}
...
func (r *EngineCache) UnmarshalJSON(bs []byte) error {
	...
	*r = EngineCache{query: selectNode(dag.query, id, "EngineCache")}
	return nil
}
...
func (r *EngineCacheEntry) UnmarshalJSON(bs []byte) error {
	...
	*r = EngineCacheEntry{query: selectNode(dag.query, id, "EngineCacheEntry")}
	return nil
}
...
func (r *EngineCacheEntrySet) UnmarshalJSON(bs []byte) error {
	...
	*r = EngineCacheEntrySet{query: selectNode(dag.query, id, "EngineCacheEntrySet")}
	return nil
}
...
func (r *Host) UnmarshalJSON(bs []byte) error {
	...
	*r = Host{query: selectNode(dag.query, id, "Host")}
	return nil
}

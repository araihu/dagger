...
func (r NodeCI) MarshalJSON() ([]byte, error) {
	var concrete struct {
...
func (r *NodeCI) UnmarshalJSON(bs []byte) error {
	var concrete struct {
		Source *dagger.Directory
	}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "NodeCI":
		...
		case "Install":
			...
			if inputArgs["ignoreScripts"] != nil {
				err = json.Unmarshal([]byte(inputArgs["ignoreScripts"]), &ignoreScripts)
				if err != nil {
					panic(fmt.Errorf("%s: %w", "failed to unmarshal input arg ignoreScripts", err))
				}
			}
			return (*NodeCI).Install(&parent, workspace, ignoreScripts)
		case "Run":
			var parent NodeCI
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
